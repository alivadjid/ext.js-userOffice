...
To start application you need sencha.

In this application made user account with ext.js.
First page is to input user login and password. If data correct user get to second page. 
At second page user work with product table. 
